public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: Trying to dequeue the second element instead of the first (Index 0)
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue function was adding a new value at index 0 instead of add it to the end
